(function(){
    ...
    function userService($rootScope, $http){
        ...
        function signup(name, email, password, success_handler, error_handler) {
            session_request("metaxcan/api/signup/", name, email, password, success_handler, error_handler)
        }

        function login(name, email, password, success_handler, error_handler) {
            session_request("metaxcan/api/login/", name, email, password, success_handler, error_handler)
        }
